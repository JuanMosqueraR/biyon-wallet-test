...
import 'package:code/ui/screens/create_account_step_13.dart';
...
class CreateAccountStep11Screen extends StatefulWidget {
  @override
  State createState() => _CreateAccountStep11State();
}

class _CreateAccountStep11State extends State<CreateAccountStep11Screen> {
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                      ...
                      child: Text(
                        S.current.sign_up_what_is_your_work_situation,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          S.current.sign_up_what_is_your_work_situation_opt_1,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          S.current.sign_up_what_is_your_work_situation_opt_2,
                          style: TextStyles.signUpDescriptionStyle,
                        ),
                        const Spacer(),
                        Image.asset(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          S.current.sign_up_what_is_your_work_situation_opt_3,
                          style: TextStyles.signUpDescriptionStyle,
                        ),
                        const Spacer(),
                        Image.asset(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          S.current.sign_up_what_is_your_work_situation_opt_4,
                          style: TextStyles.signUpDescriptionStyle,
                        ),
                        const Spacer(),
                        Image.asset(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CreateAccountStep13Screen()));
                },
